...
impl<'a, 'b, T, U, A, B> PartialEq<Slice<'b,U,B>> for Slice<'a,T,A> where
    T:PartialEq<U>+?Sized, U:?Sized, A:BufferStorage, B:BufferStorage
{
...
impl<'a, 'b, T, U, A, B> PartialOrd<Slice<'b,U,B>> for Slice<'a,T,A> where
    T:PartialOrd<U>+?Sized, U:?Sized, A:BufferStorage, B:BufferStorage
{
...
impl<'a, T:Eq+?Sized, A:BufferStorage> Eq for Slice<'a,T,A> {}
impl<'a, T:Ord+?Sized, A:BufferStorage> Ord for Slice<'a,T,A> {
    fn cmp(&self, rhs:&Self) -> Ordering { read_map!(self rhs cmp) }
}

impl<'a, T:Eq+?Sized, A:BufferStorage> Eq for SliceMut<'a,T,A> {}
impl<'a, T:Ord+?Sized, A:BufferStorage> Ord for SliceMut<'a,T,A> {
    fn cmp(&self, rhs:&Self) -> Ordering { self.as_immut().cmp(&rhs.as_immut()) }
}

impl<T:Eq+?Sized, A:BufferStorage> Eq for Buffer<T,A> {}
impl<T:Ord+?Sized, A:BufferStorage> Ord for Buffer<T,A> {
