...
impl<'a, T:?Sized, A:BufferAccess> From<&'a mut Buffer<T,A>> for BSlice<'a,T,A> {
    #[inline] fn from(bref: &'a mut Buffer<T,A>) -> Self {BSlice{ptr: bref.ptr, offset: 0, buf:PhantomData}}
}
